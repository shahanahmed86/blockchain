...
})(
	{
			...
			function (t, e, n) {
				var r = t('bignumber.js'),
					...
					d = function (t) {
						...
						return h(e)
							? new r(e, 16)
									.minus(new r('ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16))
									.minus(1)
							: new r(e, 16);
					},
					m = function (t) {
			...
			function (t, e, n) {
				...
				e.exports = function (t, e) {
					return (
						e &&
							'hex' === e.encoding &&
							(t.length > 2 && '0x' === t.substr(0, 2) && (t = t.substr(2)), (t = r.enc.Hex.parse(t))),
			...
			function (t, e, n) {
				var r = t('bignumber.js'),
					...
					k = function (t) {
						var e = x(t).round();
						return e.lessThan(0)
							? new r('ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff', 16).plus(e).plus(1)
							: e;
					},
					B = function (t) {
					...
					S = function (t) {
						return (
							...
							(!(!/^(0x)?[0-9a-f]{40}$/.test(t) && !/^(0x)?[0-9A-F]{40}$/.test(t)) || C(t))
						);
					},
					C = function (t) {
						t = t.replace('0x', '');
					...
					P = function (t) {
						return (
							!!/^(0x)?[0-9a-f]{512}$/i.test(t) && !(!/^(0x)?[0-9a-f]{512}$/.test(t) && !/^(0x)?[0-9A-F]{512}$/.test(t))
						);
					},
					M = function (t) {
						return (
							!!/^(0x)?[0-9a-f]{64}$/i.test(t) && !(!/^(0x)?[0-9a-f]{64}$/.test(t) && !/^(0x)?[0-9A-F]{64}$/.test(t))
						);
					};
				e.exports = {
					padLeft: s,
			...
			function (t, e, n) {
				...
				var x = function () {
					return [
						...
						new v({ name: 'version.network', getter: 'net_version', inputFormatter: d.toDecimal }),
						new v({ name: 'version.ethereum', getter: 'eth_protocolVersion', inputFormatter: d.toDecimal }),
										...
										t._eth.getTransactionReceipt(t.transactionHash, function (n, i) {
											i &&
												...
												t._eth.getCode(i.contractAddress, function (n, a) {
													if (!r && a)
														if ((o.stopWatching(function () {}), (r = !0), a.length > 3))
		...
		30: [
			function (t, e, n) {
				var r = t('../utils/utils'),
					...
					p = function (t) {
						return (
							null !== t.blockNumber && (t.blockNumber = r.toDecimal(t.blockNumber)),
					...
					b = function (t) {
						return (
							...
							t.knownStates &&
								((t.knownStates = r.toDecimal(t.knownStates)), (t.pulledStates = r.toDecimal(t.pulledStates))),
							t
						);
					};
				e.exports = {
		...
		32: [
			function (t, e, n) {
				...
				(i.prototype.prepareRequest = function (t) {
					var e;
					return (
						t ? ((e = new o()), (e.timeout = this.timeout)) : (e = new XMLHttpRequest()),
				...
				var w = function () {
					...
					x = function () {
						return [
							...
							new s({ name: 'hashrate', getter: 'eth_hashrate', outputFormatter: i.toDecimal }),
							new s({ name: 'syncing', getter: 'eth_syncing', outputFormatter: o.outputSyncingFormatter }),
							new s({ name: 'gasPrice', getter: 'eth_gasPrice', outputFormatter: o.outputBigNumberFormatter }),
							new s({ name: 'accounts', getter: 'eth_accounts' }),
							new s({ name: 'blockNumber', getter: 'eth_blockNumber', outputFormatter: i.toDecimal }),
				...
				var r = t('../../utils/utils'),
					...
					a = function () {
						return [
							...
							new o({ name: 'peerCount', getter: 'net_peerCount', outputFormatter: r.toDecimal })
						];
					};
				e.exports = i;
			},
					...
					a = function (t) {
						var e = function (e, n) {
							return e
								...
								: (o.isObject(n) && n.startingBlock && (n = r.outputSyncingFormatter(n)),
		...
		50: [
			function (t, e, n) {
				!(function (r, o, i) {
					'object' == typeof n
						? (e.exports = n = o(t('./core'), t('./enc-base64'), t('./md5'), t('./evpkdf'), t('./cipher-core')))
						...
						(function (e) {
							var n = t,
								...
								y = (m.Pkcs7 = {
									pad: function (t, e) {
										for (
											var n = 4 * e, r = n - (t.sigBytes % n), o = (r << 24) | (r << 16) | (r << 8) | r, a = [], s = 0;
											s < r;
											s += 4
										)
											a.push(o);
											...
											var n,
												...
												o = function (e) {
													...
													return function () {
														...
														var o = ((n << 16) + e) & r;
														return (o /= 4294967296), (o += 0.5), o * (t.random() > 0.5 ? 1 : -1);
													};
												},
												i = 0;
											i < e;
					...
					!(function () {
						...
						a.HMAC = r.extend({
							init: function (t, e) {
								...
								for (
									var o = (this._oKey = e.clone()), a = (this._iKey = e.clone()), s = o.words, c = a.words, u = 0;
									u < n;
									u++
								)
							...
							var n = t,
								...
								u = (i.RabbitLegacy = o.extend({
									...
									_doProcessBlock: function (t, n) {
										...
										for (var o = 0; o < 4; o++)
											(a[o] =
												(16711935 & ((a[o] << 8) | (a[o] >>> 24))) | (4278255360 & ((a[o] << 24) | (a[o] >>> 8)))),
												(t[n + o] ^= a[o]);
									},
									blockSize: 4,
									ivSize: 2
						...
						(function () {
							var e = t,
								...
								s = (i.SHA1 = o.extend({
									...
									_doProcessBlock: function (t, e) {
										for (
											var n = this._hash.words, r = n[0], o = n[1], i = n[2], s = n[3], c = n[4], u = 0;
											u < 80;
											u++
										) {
											if (u < 16) a[u] = 0 | t[e + u];
						...
						(function (e) {
							...
							(a.Word = o.extend({
								...
								(a.WordArray = o.extend({
									...
									clone: function () {
										for (
											var t = o.clone.call(this), e = (t.words = this.words.slice(0)), n = e.length, r = 0;
											r < n;
											r++
										)
											e[r] = e[r].clone();
					...
					function s(t) {
						...
						return (
							0 == (4294965248 & t)
								...
								: 0 == (4292870144 & t) && ((e = v(((t >> 18) & 7) | 240)), (e += a(t, 12)), (e += a(t, 6))),
							(e += v((63 & t) | 128))
						);
					}
					function c(t) {
				...
				!(function (t) {
					...
					function n(t) {
						function e(t, n) {
							...
							if (null != n && W(n, 2, 64, R, 'base')) {
								...
								if (
									...
									!new RegExp('^-?' + (r = '[' + b.slice(0, n) + ']+') + '(?:\\.' + r + ')?$', n < 37 ? 'i' : '').test(
										c
									)
								)
									return D(u, c, a, n);
							...
							for (
								(o = c.indexOf('.')) > -1 && (c = c.replace('.', '')),
									(i = c.search(/e/i)) > 0
										? (o < 0 && (o = i), (o += +c.slice(i + 1)), (c = c.substring(0, i)))
										: o < 0 && (o = c.length),
									i = 0;
								48 === c.charCodeAt(i);
								i++
						...
						function p(t, n, r, i) {
							...
							if (
								(m < 0
									? --s
									: ((p.c = h), (p.e = s), (p.s = i), (p = T(p, d, y, g, n)), (h = p.c), (l = p.r), (s = p.e)),
								(a = s + y + 1),
								(m = h[a]),
								(u = n / 2),
								(l = l || a < 0 || null != h[a + 1]),
								(l =
									g < 4
										...
										: m > u || (m == u && (4 == g || l || (6 == g && 1 & h[a - 1]) || g == (p.s < 0 ? 8 : 7)))),
								a < 1 || !h[0])
							)
								t = l ? f('1', -y) : '0';
							else {
						...
						function F(t, e, n, r, o) {
							return (
								(t < e || t > n || t != l(t)) &&
									O(r, (o || 'decimal places') + (t < e || t > n ? ' out of range' : ' not an integer'), t),
								!0
							);
						}
						function I(t, e, n) {
							...
							return (
								(n = r + n * w - 1) > L ? (t.c = t.e = null) : n < z ? (t.c = [(t.e = 0)]) : ((t.e = n), (t.c = e)), t
							);
						}
						function O(t, e, n) {
							var r = new Error(
						...
						function N(t, e, n, r) {
							...
							if (l) {
								t: {
									...
									if (
										((r = r || e < 0 || null != l[u + 1] || (a < 0 ? c : c % p[o - a - 1])),
										(r =
											n < 4
												? (f || r) && (0 == n || n == (t.s < 0 ? 3 : 2))
												: f > 5 ||
												  (5 == f &&
														(4 == n ||
															r ||
															(6 == n && (i > 0 ? (a > 0 ? c / p[o - a] : 0) : l[u - 1]) % 10 & 1) ||
															n == (t.s < 0 ? 8 : 7)))),
										e < 1 || !l[0])
									)
										return (
									...
									if (
										(0 == i
											? ((l.length = u), (s = 1), u--)
											: ((l.length = u + 1), (s = p[w - i]), (l[u] = a > 0 ? m((c / p[o - a]) % p[a]) * s : 0)),
										r)
									)
										for (;;) {
											if (0 == u) {
						...
						return (
							...
							(e.config = e.set =
								function () {
									...
									return (
										...
										c((e = 'EXPONENTIAL_AT')) &&
											(s(t)
												? W(t[0], -S, 0, 2, e) && W(t[1], 0, S, 2, e) && ((j = 0 | t[0]), (q = 0 | t[1]))
												: W(t, -S, S, 2, e) && (j = -(q = 0 | (t < 0 ? -t : t)))),
										(r[e] = [j, q]),
										c((e = 'RANGE')) &&
											(s(t)
												? W(t[0], -S, -1, 2, e) && W(t[1], 1, S, 2, e) && ((z = 0 | t[0]), (L = 0 | t[1]))
												: W(t, -S, S, 2, e) &&
												  (0 | t ? (z = -(L = 0 | (t < 0 ? -t : t))) : U && O(2, e + ' cannot be zero', t))),
										(r[e] = [z, L]),
										c((e = 'ERRORS')) &&
											(t === !!t || 1 === t || 0 === t ? ((R = 0), (W = (U = !!t) ? F : a)) : U && O(2, e + y, t)),
										(r[e] = U),
										c((e = 'CRYPTO')) &&
											(t === !0 || t === !1 || 1 === t || 0 === t
												? t
													? ((t = 'undefined' == typeof crypto),
													  !t && crypto && (crypto.getRandomValues || crypto.randomBytes)
															? (J = !0)
															: U
										...
										if (crypto.getRandomValues) {
											for (r = crypto.getRandomValues(new Uint32Array((a *= 2))); c < a; )
												(s = 131072 * r[c] + (r[c + 1] >>> 11)),
													s >= 9e15
														? ((o = crypto.getRandomValues(new Uint32Array(2))), (r[c] = o[0]), (r[c + 1] = o[1]))
														: (u.push(s % 1e14), (c += 2));
											c = a / 2;
							...
							(T = (function () {
								...
								return function (i, a, s, c, u) {
									...
									if (!(T && T[0] && D && D[0]))
										return new e(
											i.s && a.s && (T ? !D || T[0] != D[0] : D) ? ((T && 0 == T[0]) || !D ? 0 * O : O / 0) : NaN
										);
									for (
										v = new e(O),
											b = v.c = [],
											l = i.e - a.e,
											O = s + l + 1,
											u || ((u = _), (l = r(i.e / w) - r(a.e / w)), (O = (O / w) | 0)),
											p = 0;
										D[p] == (T[p] || 0);
										p++
									);
									if ((D[p] > (T[p] || 0) && l--, O < 0)) b.push(1), (h = !0);
										...
										for (
											C = T.length,
												...
												O += 2,
												d = m(u / (D[0] + 1)),
												d > 1 && ((D = t(D, d, u)), (T = t(T, d, u)), (F = D.length), (C = T.length)),
												S = F,
												x = T.slice(0, F),
												k = x.length;
											k < F;
								...
								return function (a, s, c, u) {
									...
									if (o.test(l)) a.s = isNaN(l) ? null : l < 0 ? -1 : 1;
										...
										if (
											...
											u && ((f = u), (l = l.replace(n, '$1').replace(r, '0.$1'))),
											s != l)
										)
											return new e(l, f);
								...
								function (t, n) {
									...
									return (
										...
										!i.c || !t.s || (t.c && !t.c[0])
											...
											? new e(i)
											: (9 == G
													? ((o = t.s), (t.s = 1), (r = T(i, t, 0, 3)), (t.s = o), (r.s *= o))
													: (r = T(i, t, 0, G)),
											  i.minus(r.times(t)))
									);
								}),
							...
							(E.round = function (t, n) {
								var r = new e(this);
								return (
									(null == t || W(t, 0, S, 15)) && N(r, ~~t + this.e + 1, null != n && W(n, 0, 8, 15, g) ? 0 | n : H), r
								);
							}),
							(E.shift = function (t) {
								var n = this;
								return W(t, -x, x, 16, 'argument')
									? n.times('1e' + l(t))
									: new e(n.c && n.c[0] && (t < -x || t > x) ? n.s * (t < 0 ? 0 : 1 / 0) : n);
							}),
							(E.squareRoot = E.sqrt =
								function () {
									var t,
									...
									if (
										...
										for (l = i.e, f = l + p, f < 3 && (f = 0); ; )
											if (
												((s = i), (i = h.times(s.plus(T(c, s, p, 1)))), o(s.c).slice(0, f) === (n = o(i.c)).slice(0, f))
											) {
									...
									if (!(x && k && x[0] && k[0]))
										return (
											!b.s || !t.s || (x && !x[0] && !k) || (k && !k[0] && !x)
												? (t.c = t.e = t.s = null)
												: ((t.s *= b.s), x && k ? ((t.c = [0]), (t.e = 0)) : (t.c = t.e = null)),
											t
										);
									for (
										i = r(b.e / w) + r(t.e / w),
									...
									n = u
										? c +
										  ...
										  ((a = +X.fractionGroupSize)
												? u.replace(new RegExp('\\d{' + a + '}\\B', 'g'), '$&' + X.fractionGroupSeparator)
												: u)
										: c;
								}
								return n;
							...
							(E.toFraction = function (t) {
								...
								if (
									(null != t &&
										...
										(U = p),
										((p = c.isInt()) && !c.lt(P)) ||
											(U && O(22, 'max denominator ' + (p ? 'out of range' : 'not an integer'), t),
								...
								return (
									...
									(a *= 2),
									(n =
										T(y, g, a, H).minus(h).abs().cmp(T(u, r, a, H).minus(h).abs()) < 1
							...
							(E.toPower = E.pow =
								function (t, n) {
									...
									if (
										...
										(!W(t, -x, x, 23, 'exponent') &&
											(!isFinite(t) || (a > x && (t /= 0)) || (parseFloat(t) != t && !(t = NaN)))) ||
											0 == t)
									)
							...
							(E.valueOf = E.toJSON =
								function () {
									...
									return null === n
										? e.toString()
										: ((t = o(e.c)), (t = n <= j || n >= q ? u(t, n) : f(t, n)), e.s < 0 ? '-' + t : t);
								}),
							(E.isBigNumber = !0),
							null != t && e.config(t),
							e
					...
					(p = n()),
						...
						'function' == typeof define && define.amd
							...
							? (e.exports = p)
							: (t || (t = 'undefined' != typeof self ? self : Function('return this')()), (t.BigNumber = p));
				})(this);
			},
			{}
		],
